...
export default function CreateCustomerPage() {
  ...
  const loadUserDivision = async () => {
    try {
      // If user is System Admin, load all divisions and allow selection
      if (user?.role === 'IT') {
      ...
      // Get user's first division from userApprovals (non-admin)
      if (user?.userApprovals && user.userApprovals.length > 0) {
        ...
        // Set divisionId in form
        setFormData(prev => ({ ...prev, divisionId }))

        // Fetch max approval levels for this division
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    // If admin selects division, fetch max approval levels
      ...
      <div className="user-container">
        <div className="user-header">
          ...
          <div className="user-title">
            ...
            <p>Register a new customer for KYC approval process</p>
          </div>
        </div>
            ...
            <div className="user-form-grid">
              <div className="user-form-group">
                <label htmlFor="customerCode">
                  Customer Code <span style={{ color: '#fca5a5' }}>*</span>
                </label>
                <input
                  type="text"
                  id="customerCode"
              ...
              <div className="user-form-group">
                <label htmlFor="customerName">
                  Customer Name <span style={{ color: '#fca5a5' }}>*</span>
                </label>
                <input
                  type="text"
                  id="customerName"
        ...
        <div className="user-card" style={{ marginTop: '2rem' }}>
          ...
          <ul style={{ 
            ...
            <li>Customer code must be unique</li>
            <li>Email address must be valid and unique</li>
            <li>Once created, customer will be in DRAFT status</li>
            <li>You can submit for approval after verifying all information</li>
            <li>Approval akan berjalan berurutan sesuai level yang tersedia di divisi (Level 1 → Level 2 → Level 3)</li>
          </ul>
        </div>
      </div>
    </div>
